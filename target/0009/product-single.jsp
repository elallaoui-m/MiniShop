    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3><c:out value="${article.designation}"/></h3>
	             	...
	             	<span class="input-group-btn ml-2">
	                	<button type="button" class="quantity-right-plus btn" data-type="plus" data-field="">
	                     <i class="ion-ios-add"></i>
								...
								<input type="hidden"  id="code" name="code" value="<c:out value="${article.codeArticle}" default="0"/>">
							</form>
	          	<div class="w-100"></div>
	          	<div class="col-md-12">
	          		<p style="color: #000;"><c:out value="${article.stock}" default="0"/> piece available</p>
	          	</div>
          	</div>
          	<p><button type="submit"  class="btn btn-black py-3 px-5 mr-2">Add to Cart</button>
    			</div>
    		</div>
    	</div>
    </section>
